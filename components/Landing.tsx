...
const content = {
  ...
  de: {
    ...
    features: [
      ...
      { number: '58', unit: 'Technologien in fünf Epochen', title: 'Führe deine Basis durch fünf Epochen', text: 'Beginne mit Handwerkzeugen und Holz. Arbeite dich über Elektrizität und Maschinen bis zur Nanotechnologie vor, ohne die Schritte dazwischen zu überspringen.' },
  ...
  fr: {
    ...
    features: [
      { number: '43', unit: 'types de bâtiments, obélisque compris', title: 'Construisez une base fonctionnelle', text: 'Reliez générateurs, accumulateurs, lampes, machines de production et six types de tourelles dans un même réseau électrique.' },
      { number: '58', unit: 'technologies réparties sur cinq ères', title: 'Progressez à travers cinq ères', text: 'Commencez avec des outils manuels et du bois, puis atteignez l’électricité, les machines et les nanotechnologies sans brûler les étapes.' },
  ...
  es: {
    ...
    features: [
      { number: '43', unit: 'tipos de edificios, incluido el obelisco', title: 'Construye una base funcional', text: 'Conecta generadores, baterías, lámparas, máquinas de producción y seis tipos de torretas mediante una red eléctrica.' },
  ...
  tr: {
    kicker: 'Kuş bakışı hayatta kalma ve üretim · iPhone ve iPad',
    ...
    features: [
      { number: '43', unit: 'obelisk dâhil yapı türü', title: 'İşleyen bir üs kur', text: 'Jeneratörleri, aküleri, lambaları, üretim makinelerini ve altı tür tareti bir enerji şebekesinde birbirine bağla.' },
...
const mediaCopy: Record<Locale, {
  ...
  fr: {
    schemaDescription: 'Un jeu de survie, d’artisanat et de défense de base en pixel art pour iPhone et iPad.',
  ...
  es: {
    schemaDescription: 'Un juego de supervivencia, fabricación y defensa de bases con gráficos pixel art para iPhone y iPad.',
  ...
  tr: {
    schemaDescription: 'iPhone ve iPad için piksel grafikli bir hayatta kalma, üretim ve üs savunma oyunu.',
