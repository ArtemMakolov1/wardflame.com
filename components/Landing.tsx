...
const content = {
  en: {
    ...
    languages: 'Game · EN / RU · Site · 6 languages',
  ...
  ru: {
    ...
    status: 'В разработке',
    platform: 'iOS / iPadOS 17+',
    languages: 'Игра · RU / EN · Сайт · 6 языков',
    introIndex: '01 / Игра',
  ...
  de: {
    ...
    platform: 'iOS / iPadOS 17+',
    languages: 'Spiel · EN / RU · Website · 6 Sprachen',
  ...
  fr: {
    ...
    platform: 'iOS / iPadOS 17+',
    languages: 'Jeu · EN / RU · Site · 6 langues',
  ...
  es: {
    ...
    platform: 'iOS / iPadOS 17+',
    languages: 'Juego · EN / RU · Sitio · 6 idiomas',
  ...
  tr: {
    ...
    platform: 'iOS / iPadOS 17+',
    languages: 'Oyun · EN / RU · Site · 6 dil',
    introIndex: '01 / Oyun',
